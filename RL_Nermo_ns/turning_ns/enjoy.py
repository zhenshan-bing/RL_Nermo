...
from nermo_rl_locomotion.utils.evaluation_util import generate_hildebrand_plot, plot_metrics_over_episode
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cam-ids", nargs="+", type=int, default=[1], help="Ids of the MuJoCo cameras for which a video should be recorded (one video for each camera). For rendering to the screen the first camera in the given list is used for the initial point of view.")
