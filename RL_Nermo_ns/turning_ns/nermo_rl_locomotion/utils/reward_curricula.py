...
class BaseCurriculum(object):
    def __init__(self, initial_curriculum_factors: List[float], max_curriculum_factors: Union[float, List[float]] = None):
...
class LinearTimeCurriculum(BaseCurriculum):
    ...
    def step_curriculum(self, primary_reward: float, secondary_rewards: List[float]):
        ...
        self._curriculum_factors = self.initial_curriculum_factors + (self.n_steps * self.increase_per_step)
