# Adapted from: https://github.com/DLR-RM/rl-baselines3-zoo/blob/v1.3.0/utils/hyperparams_opt.py 
...
def sample_ppo_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    if use_sde:
        ...
        log_std_init = 0.0
    if use_sde:
        squash_output = trial.suggest_categorical('squash_output', [False, True])
    else:
        squash_output = False
    ...
    net_arch = {
        "small": [dict(pi=[64, 64], vf=[64, 64])],          # Corresponds to the default netwark architechtrue of SB3
